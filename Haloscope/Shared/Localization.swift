...
enum L10n {
    ...
    private static let translations: [String:Translation] = [
        ...
        "settings.card_opacity": .init(english:"Content card opacity",simplifiedChinese:"内容卡片透明度"),
        "settings.text_color": .init(english:"Panel text color",simplifiedChinese:"面板文字颜色"),
        "text_color.white": .init(english:"White",simplifiedChinese:"白色"),
        "text_color.black": .init(english:"Black",simplifiedChinese:"黑色"),
        "settings.liquid_glass_hint": .init(english:"Uses native clear Liquid Glass on macOS 26 or later. Earlier versions use a translucent material fallback.",simplifiedChinese:"macOS 26 及以上使用原生全透明液态玻璃；旧版系统自动使用半透明材质。"),
